...
import com.abdulkarim.adminapp.activity.OrderActivity;
...
public class PendingFragment extends Fragment {
    ...
    private void getMyOrders() {
        ...
        firebaseFirestore.collection(DBHelper.COLLECTION_ORDER).whereEqualTo("order_status","pending").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
